...
def TwoDynSpectraPlot(Data_Ch_A, Data_Ch_B, VminA, VmaxA, VminB, VmaxB, Suptitle,
    ...
    '''
    no_of_spectra = Nim * spInFrame * FrameInChunk
    fig_file_name = path + df_filename[0:14] + FigFileName + str(figID+1) + '.png'
    TimeFigureScaleFig[k] = TimeFigureScale[k][0:11]
    TimeScaleFig[k] = TimeScale[k][11:23]
    Suptitle = str(df_filename[0:18])+
