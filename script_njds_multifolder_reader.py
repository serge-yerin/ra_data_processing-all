...
Software_name = 'New .jds multifolder data files reader'
...
path_to_data = '../../RA_DATA_ARCHIVE/NJDS_cross_spectra_new_DSP_receiver/'
...
Vmin = -150                   # Lower limit of figure dynamic range
# Vmax = -40                    # Upper limit of figure dynamic range
Vmax = 150                    # Upper limit of figure dynamic range
...
VmaxNorm = 100                 # Upper limit of figure dynamic range for normalized spectra
...
for folder_no in range(num_of_folders):
    ...
    done_or_not, DAT_file_name, DAT_file_list = njds_file_reader(file_name_list_current, result_path, MaxNsp, spSkip,
