...
Software_name = 'RPR multifolder data files reader'
...
from package_ra_data_files_formats.RPR_file_reader import rpr_file_reader
...
for folder_no in range (num_of_folders):
    ...
    done_or_not, DAT_file_name, DAT_file_list = rpr_file_reader(file_name_list_current, result_path, MaxNim,
