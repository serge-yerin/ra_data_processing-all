...
#ax2.set_ylim([-100, -50])
pylab.savefig(path_to_data + '01 - Spectra of interferometric responce 08.png', bbox_inches = 'tight', dpi = 160)
plt.close('all')
...
rc('font', size = 6, weight='bold')
fig = plt.figure(figsize = (9, 5))
fig.suptitle('Interferometric responce of high frequencies', fontsize = 8, fontweight='bold')
ax1 = fig.add_subplot(111)
plt.axvline(x = x_center, linewidth = '0.5' , color = 'r') #, alpha=0.5
...
ax1.set_xticklabels(text, fontsize = 6, fontweight = 'bold')
fig.subplots_adjust(top=0.92)
pylab.savefig(path_to_data + '02 - Interferometric responce 08.png', bbox_inches = 'tight', dpi = 160)
plt.close('all')

rc('font', size = 6, weight='bold')
fig = plt.figure(figsize = (9, 5))
fig.suptitle('Interferometric responce of high frequencies vs. initial signal', fontsize = 8, fontweight='bold')
ax1 = fig.add_subplot(111)
plt.axvline(x = x_center, linewidth = '0.5' , color = 'r') #, alpha=0.5
ax1.plot(2 * signal_re, linestyle = '-', linewidth = '1.00', label = 'Filtered')
ax1.plot(y_value[0, :], linestyle = '-', linewidth = '1.00', label = 'Measured')
...
ax1.set_xticklabels(text, fontsize = 6, fontweight = 'bold')
fig.subplots_adjust(top=0.92)
pylab.savefig(path_to_data + '02 - Interferometric responce 09.png', bbox_inches = 'tight', dpi = 160)
plt.close('all')


rc('font', size = 6, weight='bold')
fig = plt.figure(figsize = (9, 5))
fig.suptitle('Interferometric responce of high frequenciesvs. 5 harmonics', fontsize = 8, fontweight='bold')
ax1 = fig.add_subplot(111)
plt.axvline(x = x_center, linewidth = '0.5' , color = 'r') #, alpha=0.5
...
ax1.set_xticklabels(text, fontsize = 6, fontweight = 'bold')
fig.subplots_adjust(top=0.92)
pylab.savefig(path_to_data + '02 - Interferometric responce 10.png', bbox_inches = 'tight', dpi = 160)
plt.close('all')
