...
# Program intended to read, show and analyze data of pulsar observation from SMD files
...
file.seek(12)   # Jump to 12 byte of the file, where matrix starts
